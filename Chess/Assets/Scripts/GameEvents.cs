...
public static class GameEvents
{
    ...
    public static event Action<ChessPiece, Vector2Int> OnCheckEventRaised = delegate { };
    public static event Action OnDrawEventRaised = delegate { };
    ...
    public static void RaiseCheckEvent(ChessPiece piece, Vector2Int to) => OnCheckEventRaised?.Invoke(piece, to);
    public static void RaiseDrawEvent() => OnDrawEventRaised?.Invoke();
}